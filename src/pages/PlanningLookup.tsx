...
export default function PlanningLookup() {
  ...
  const openExternal = useCallback(async (reason: "auto" | "manual") => {
    ...
    // Mở tab ngoài
    try {
      window.open(PLANNING_URL, "_blank", "noopener,noreferrer");
    } catch {
      /* ignore */
    }
